...
if __name__ == '__main__':
    ...
    bbox_pub = rospy.Publisher('radar1det', MarkerArray, queue_size=5)
    text_pub = rospy.Publisher('radar1text', MarkerArray, queue_size=5)
    arrow_pub = rospy.Publisher('radar1arrow', MarkerArray, queue_size=5)
